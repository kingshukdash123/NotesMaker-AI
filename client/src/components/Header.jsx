...
import { Sparkles, Terminal, AlertCircle, RefreshCw, LogIn, LogOut, User } from 'lucide-react';
...
export default function Header({ 
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-md border-b border-zinc-800/80 px-3 sm:px-8 py-3">
              ...
              {userDropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-zinc-950 border border-zinc-800 rounded-xl shadow-2xl py-1 z-50 animate-fadeIn">
                  <div className="px-3 py-2 border-b border-zinc-800 text-xs">
                    ...
                    <p className="font-semibold text-zinc-100 truncate">{getUserDisplayName(currentUser)}</p>
                  </div>
                  <button
