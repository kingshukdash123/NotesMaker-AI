...
export default function Header({
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-[90] backdrop-blur-md px-3 sm:px-8 py-3 transition-colors duration-200 border-b ${isDark ? 'bg-black/80 border-zinc-800/80' : 'bg-white/90 border-zinc-200/80 shadow-xs'}`}>
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          ...
          >
            ...
            <div className="flex items-center gap-1 sm:gap-1.5">
              <span className={`text-base sm:text-lg font-bold tracking-tight ${isDark ? 'text-zinc-50' : 'text-zinc-900'
                }`}>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {currentUser && (
            <button
              ...
              className={`hidden lg:flex w-8 h-8 rounded-full transition items-center justify-center cursor-pointer select-none ${isDark
